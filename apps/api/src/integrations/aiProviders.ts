...
export const AI_PROVIDERS: ProviderDef[] = [
  ...
  { id: "sambanova", label: "SambaNova — free, fast", transport: "openai", baseURL: "https://api.sambanova.ai/v1", defaultModel: "Meta-Llama-3.3-70B-Instruct", free: true, inPerM: 0, outPerM: 0, needsKey: true, hint: "cloud.sambanova.ai (no card; low daily caps)" },
  { id: "together", label: "Together AI — free tier", transport: "openai", baseURL: "https://api.together.xyz/v1", defaultModel: "meta-llama/Llama-3.3-70B-Instruct-Turbo-Free", free: true, inPerM: 0, outPerM: 0, needsKey: true, hint: "api.together.xyz/settings/api-keys (no card)" },
  { id: "zai", label: "Z.ai GLM — free flash", transport: "openai", baseURL: "https://api.z.ai/api/paas/v4", defaultModel: "glm-4.5-flash", free: true, inPerM: 0, outPerM: 0, needsKey: true, hint: "z.ai → API Keys (no card; use api.z.ai, not bigmodel.cn)" },
  ...
  { id: "deepinfra", label: "DeepInfra — very cheap", transport: "openai", baseURL: "https://api.deepinfra.com/v1/openai", defaultModel: "meta-llama/Meta-Llama-3.1-8B-Instruct-Turbo", free: false, inPerM: 0.02, outPerM: 0.04, needsKey: true, hint: "deepinfra.com (no card to start)" },
  { id: "fireworks", label: "Fireworks AI", transport: "openai", baseURL: "https://api.fireworks.ai/inference/v1", defaultModel: "accounts/fireworks/models/llama-v3p1-8b-instruct", free: false, inPerM: 0.1, outPerM: 0.2, needsKey: true, hint: "fireworks.ai (model ids must be fully qualified)" },
  { id: "nvidia", label: "NVIDIA NIM", transport: "openai", baseURL: "https://integrate.api.nvidia.com/v1", defaultModel: "meta/llama-3.1-8b-instruct", free: false, inPerM: 0.1, outPerM: 0.2, needsKey: true, hint: "build.nvidia.com (free starter credits, no card)" },
  { id: "huggingface", label: "Hugging Face router", transport: "openai", baseURL: "https://router.huggingface.co/v1", defaultModel: "openai/gpt-oss-20b:cheapest", free: false, inPerM: 0.05, outPerM: 0.2, needsKey: true, hint: "huggingface.co/settings/tokens (aggregator; only a tiny free credit)" },
